...
website_host = System.get_env("WEBSITE_HOST") || "api.prod.eps-infra.net"
...
# For production, remember to configure the url host
...
#
#     config :eps, EPSWeb.Endpoint, server: true
#
